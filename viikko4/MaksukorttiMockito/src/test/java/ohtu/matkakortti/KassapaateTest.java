...
public class KassapaateTest {
    ...
    @Test
    public void lataaLisaaMaksukortilleLadattavanRahamaaranJosSummaPositiivinen() {
    ...
    @Test
    public void lataaEiLisaaMaksukortilleLadattavaaRahamaaraaJosSummaNegatiivinen() {
        kassa.lataa(kortti, -1);
        kassa.lataa(kortti, 0);
